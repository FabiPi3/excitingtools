...
class SpeciesFile:
    ...
    def remove_lo_highest_matching_order(self, l: int, n: int) -> (bool, int):
        ...
        :param l: angular momentum number l
        :param n: principal quantum number n
        :return: tuple of states if the given local orbital was present in the basis and highest matching order
        """
        mO = self.find_highest_matching_order_for_state(l, n)

        return self.remove_lo(l, (n, n), (mO - 1, mO)), mO
